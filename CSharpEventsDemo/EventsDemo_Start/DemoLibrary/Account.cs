...
namespace DemoLibrary
{
    public class Account
    {
        ...
        public event EventHandler<OverdraftEventArgs> OverdarftEvent;
            ...
            else
            {
                ...
                if (backupAccount != null)
                {
                    ...
                    if ((backupAccount.Balance + Balance) > amount)
                    {
                        ...
                        OverdraftEventArgs args = new OverdraftEventArgs(amountNeeded, "extrainfo");
                        OverdarftEvent?.Invoke(this,args );

                        if(args.CancleTransaction == true)
                        {
                            return false;
                        }
