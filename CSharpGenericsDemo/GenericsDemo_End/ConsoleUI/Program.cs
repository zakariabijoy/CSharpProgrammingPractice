...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void DemonstrateTextFileStorage()
        {
            ...
            string peopleFile = @"F:\Programming\C# Programing\prgming\CSharpGenericsDemo\GenericsDemo_End\people.csv";
            string logFile = @"F:\Programming\C# Programing\prgming\CSharpGenericsDemo\GenericsDemo_End\logs.csv";
